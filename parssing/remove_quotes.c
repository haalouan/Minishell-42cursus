...
{
    while (list && list[*i] && list[*i]->redir && list[*i]->redir[*j] != '\0')
    {
        ...
        else if (list && list[*i] && list[*i]->redir && list[*i]->redir[*j] && list[*i]->redir[*j] == '\'')
        {
            (*j)++;
            while (list && list[*i] && list[*i]->redir && list[*i]->redir[*j] && list[*i]->redir[*j] != '\'')
                list[*i]->redir[(*k)++] = list[*i]->redir[(*j)++];
